			...
			<div class="col-md-12">
				<div class="box">
					<div class="box-header with-border">
						<h3 class="box-title">Monthly Analytical Report</h3>
...
<!-- ChartJS -->
<script src="<?php echo assets('vendors/Chart.js/Chart.js'); ?>"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="<?php echo assets('js/pages/dashboard2.js'); ?>"></script>
