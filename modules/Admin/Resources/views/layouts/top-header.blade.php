                ...
                <span class="avatar avatar-online">
                  ...
                  <i></i>
                        ...
                        <div class="username-details">
                            <div class="fullname">{{ucwords(auth()->user()->first_name . " " . auth()->user()->last_name)}}</div>
                    ...
                    <div class="dropdown-menu" role="menu" style="min-width: 250px;">
                        @foreach(config('menu.admin.user_profile') as $menu)
                            ...
                            <a class="dropdown-item" href="{{Route::has($menu['route']) ?  route($menu['route']) : url($menu['url'] ?? "#")}}" role="menuitem"><i class="{{$menu['icon']}}"
                                                                                                  aria-hidden="true"></i>
                                {{$menu['title']}}</a>
                            @endforeach
                        <div class="dropdown-divider" role="presentation"></div>
                        <a class="dropdown-item" href="{{route("admin.logout.simple")}}" role="menuitem"><i class="icon wb-power"
                                                                                              aria-hidden="true"></i>
                            Logout</a>
                    </div>
                </li>
