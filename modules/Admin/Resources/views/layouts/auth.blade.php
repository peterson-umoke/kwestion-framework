...
<head>
    ...
    <title>@yield("title","Sign In") | {{config('app.name','PilotFramework')}}</title>
    ...
    <link rel="stylesheet" href="{{url('/modules/Admin/')}}/Resources/assets/global/vendor/asscrollable/asScrollable.css">
    ...
    <link rel="stylesheet" href="{{url('/modules/Admin/')}}/Resources/assets/examples/css/pages/login-v2.css">


    <!-- Fonts -->
    <link rel="stylesheet" href="{{url('/modules/Admin/')}}/Resources/assets/global/fonts/web-icons/web-icons.min.css">
    <link rel="stylesheet" href="{{url('/modules/Admin/')}}/Resources/assets/global/fonts/brand-icons/brand-icons.min.css">
...
<style>
    ...
    .page-login-v2:before {
        background-image: url(@yield('bgImage','http://localhost/pilotframework/modules/Admin/Resources/assets/examples/images/login.jpg')) !important;
    }
</style>
<!-- Page -->
<div class="page" data-animsition-in="fade-in" data-animsition-out="fade-out">
    <div class="page-content">
        <div class="page-brand-info">
            <div class="brand">
                <img class="brand-img" src="{{url('/modules/Admin/')}}/Resources/assets/images/logo@2x.png" alt="...">
                <h2 class="brand-text font-size-40">{{config('app.name',"PilotFramework")}}</h2>
            </div>
        </div>

        <div class="page-login-main animation-slide-right animation-duration-1">
            <div class="brand hidden-md-up">
                <img class="brand-img" src="{{url('/modules/Admin/')}}/Resources/assets/images/logo-colored@2x.png" alt="...">
                <h3 class="brand-text font-size-40">{{config('app.name')}}</h3>
            </div>
            <h3 class="font-size-24">@yield("title","Sign In")</h3>
            <p>@yield("description","Sign in using your email and password").</p>
...
<!-- Core  -->
<script src="{{url('/modules/Admin/')}}/Resources/assets/global/vendor/babel-external-helpers/babel-external-helpers.js"></script>
...
<script src="{{url('/modules/Admin/')}}/Resources/assets/global/vendor/jquery-placeholder/jquery.placeholder.js"></script>
...
<script src="{{url('/modules/Admin/')}}/Resources/assets/global/js/Plugin/jquery-placeholder.js"></script>
